...
public class DemographicsServices {
    ...
    /**
     * Creates a new instance of DemographicsServices
     */
    public DemographicsServices() {
    }

    /**
     * Retrieves representation of an instance of com.tcs.medlife.member.services.DemographicsServices
    ...
    public String getJson(@PathParam("memberId")String Id) {
      ...
      try {
            return MongoUtils.get("DEMOGRAPHICS");
    ...
    /**
     * PUT method for updating or creating an instance of DemographicsServices
